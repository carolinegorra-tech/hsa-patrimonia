...
# Gera o .docx "Lista Inicial de Documentos" com Concluído/Pendente verde/
# vermelho ao lado de cada um dos 12 itens. Pode ser disparado MESMO antes
# de processar a DIRPF (sem nome de cliente → usa "Cliente" como placeholder).
...
def build_document_checklist_endpoint(body: ChecklistBody):
    # Import diferido: se checklist_builder quebrar por algum motivo, só
    # este endpoint falha. O app continua de pé.
    ...
    try:
        checklist_builder.build_checklist(
            data.get("client", ""),
    ...
    return FileResponse(
        ...
        filename=_safe_filename(data.get("client", ""), "LISTA_DOCUMENTOS", "docx"),
    )
